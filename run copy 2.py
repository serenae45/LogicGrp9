...
"""
one[i][j] - there is a 1 in the tile [i][j]
two[i][j] - there is a 2 in the tile [i][j]
three[i][j] - there is a 3 in the tile [i][j]
four[i][j] - there is a 4 in the tile [i][j]
five[i][j] - there is a 5 in the tile [i][j]
six[i][j] - there is a 6 in the tile [i][j]
seven[i][j] - there is a 7 in the tile [i][j]
eight[i][j] - there is a 8 in the tile [i][j]
blank[i][j] - there is a 9 in the tile [i][j]
"""
one = [
    [Var('1@00'),Var('1@01'),Var('1@02')],
    [Var('1@10'),Var('1@11'),Var('1@12')],
    [Var('1@20'),Var('1@21'),Var('1@22')]]


two = [
    [Var('2@00'),Var('2@01'),Var('2@02')],
    [Var('2@10'),Var('2@11'),Var('2@12')],
    [Var('2@20'),Var('2@21'),Var('2@22')]]
three = [
    [Var('3@00'),Var('3@01'),Var('3@02')],
    [Var('3@10'),Var('3@11'),Var('3@12')],
    [Var('3@20'),Var('3@21'),Var('3@22')]]
four = [
    [Var('4@00'),Var('4@01'),Var('4@02')],
    [Var('4@10'),Var('4@11'),Var('4@12')],
    [Var('4@20'),Var('4@21'),Var('4@22')]]
five = [
    [Var('5@00'),Var('5@01'),Var('5@02')],
    [Var('5@10'),Var('5@11'),Var('5@12')],
    [Var('5@20'),Var('5@21'),Var('5@22')]]
six = [
    [Var('6@00'),Var('6@01'),Var('6@02')],
    [Var('6@10'),Var('6@11'),Var('6@12')],
    [Var('6@20'),Var('6@21'),Var('6@22')]]
seven = [
    [Var('7@00'),Var('7@01'),Var('7@02')],
    [Var('7@10'),Var('7@11'),Var('7@12')],
    [Var('7@20'),Var('7@21'),Var('7@22')]]
eight = [
    [Var('8@00'),Var('8@01'),Var('8@02')],
    [Var('8@10'),Var('8@11'),Var('8@12')],
    [Var('8@20'),Var('8@21'),Var('8@22')]]
blank = [
    [Var('b@00'),Var('b@01'),Var('b@02')],
    [Var('b@10'),Var('b@11'),Var('b@12')],
    ...
    for i in range(3):
        for j in range(3):
            if(board[i][j] == '1'):
                ...
                for tile in TILES:
                    if tile != '1':
                        E.add_constraint(~Asssigned(tile, (i, j))
            elif(board[i][j] == '2'):
                E.add_constraint(two[i][j])
                for tile in TILES:
                    if tile != '2':
                        E.add_constraint(~tile[i][j])
            elif(board[i][j] == '3'):
                E.add_constraint(three[i][j])
                for tile in TILES:
                    if tile != '3':
                        E.add_constraint(~tile[i][j])
            elif(board[i][j] == '4'):
                E.add_constraint(four[i][j])
                for tile in TILES:
                    if tile != '4':
                        E.add_constraint(~tile[i][j])
            elif(board[i][j] == '5'):
                E.add_constraint(five[i][j])
                for tile in TILES:
                    if tile != '5':
                        E.add_constraint(~tile[i][j])
            elif(board[i][j] == '6'):
                E.add_constraint(six[i][j])
                for tile in TILES:
                    if tile != '6':
                        E.add_constraint(~tile[i][j])
            elif(board[i][j] == '7'):
                E.add_constraint(seven[i][j])
                for tile in TILES:
                    if tile != '7':
                        E.add_constraint(~tile[i][j])
            elif(board[i][j] == '8'):
                E.add_constraint(eight[i][j])
                for tile in TILES:
                    if tile != '8':
                        E.add_constraint(~tile[i][j])
            elif(board[i][j] == 'blank'):
                E.add_constraint(blank[i][j])
                for tile in TILES:
                    if tile != 'blank':
                        E.add_constraint(~tile[i][j])
            else:
